...
<div class="card">
    <div class="row no-gutters">
        <div class="col-md-4"><img src="{{ asset('storage/img/' . $data['hotel_image']) }}" alt="" class="card-img">
        </div>
        <div class="col-md-8">
            <div class="card-body">
...
<table class="table table-hover table-bordered">
    ...
    <tbody class="bg-white text-center">
        ...
        <td><button class="btn btn-primary"><a class="text-light"
                    href="{{ url('member/add_reservation'.'/'.$plan->id) }}">予約する</a></button></td>
    </tbody>
    @endforeach
</table>
@else
